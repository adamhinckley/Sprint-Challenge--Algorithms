class SortingRobot:
    ...
    def sort(self):
        ...
        """
        # uses the default light condition to start the loop
        while self.light_is_on() == False:
            self.set_light_on()
        # starts moving right across the array and swapping items if the held item is greater
            while self.can_move_right():
                if self.compare_item() == 1:
                    ...
                    self.swap_item()
                    self.move_right()
            # if light is off go back to the beginning
